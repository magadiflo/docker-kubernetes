...
Ahora, para comunicar nuestros microservicios crearemos la red `dk-network`.

````bash
$ docker network create dk-network
e10b7d2d8b58f89bc50449458f1d10f92b11156ed19bf8bbbab4d7376fdb4354
````

Listamos nuevamente las redes. Vemos que la red `dk-network` está creada correctamente.

````bash
$ docker network ls
NETWORK ID     NAME          DRIVER    SCOPE
3909a0c11dff   bridge        bridge    local
e10b7d2d8b58   dk-network    bridge    local
6dac92048c81   host          host      local
4eea7e69fe4f   none          null      local
````
