...
````bash
$ docker container run -d -p 3307:3306 --rm --name c-mysql --network docker-network -e MYSQL_ROOT_PASSWORD=magadiflo -e MYSQL_DATABASE=db_user_service -e MYSQL_USER=admin -e MYSQL_PASSWORD=magadiflo mysql:8.0.33
